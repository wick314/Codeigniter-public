...
class Home extends CI_Controller {
	...
	public function index()
	{
		...
		$data['view_article_all'] = $this->Model_home->get_all();
		$data['view_article_news'] = $this->Model_home->get_news();	
		$data['view_fist_news'] = $this->Model_home->get_fist_news();	
		$data['view_six_news'] = $this->Model_home->get_six_news();	
		$data['view_fist_tt'] = $this->Model_home->get_fist_tt();	
		$data['view_six_tt'] = $this->Model_home->get_six_tt();	
		$data['view_fist_event'] = $this->Model_home->get_fist_event();	
		$data['view_six_event'] = $this->Model_home->get_six_event();	
		$data['view_fist_tut'] = $this->Model_home->get_fist_tut();	
		$data['view_six_tut'] = $this->Model_home->get_six_tut();
		$data['view_fist_cd'] = $this->Model_home->get_fist_cd();	
		$data['view_six_cd'] = $this->Model_home->get_six_cd();
