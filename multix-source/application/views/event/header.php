...
<head>
    ...
    if($class_name == 'news')
    {
        if($segment_3 == 0) {
            ...
            echo '<title>'.$news_single_item['news_title'].'</title>';
    ...
    <link rel="stylesheet" href="<?php echo base_url(); ?>public/css/cssCharts.css">
...
<body>
    ...
    <div id="strickymenu"></div>
    <!--Menu Start-->
    <div id="nav-menu" class="menu-area">
        <div class="container">
            <div class="row">
