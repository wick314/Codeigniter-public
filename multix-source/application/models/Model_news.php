...
class Model_news extends CI_Model 
{
    ...
    public function news_check($id,$slug)
    {
          if ($id === 0 && $slug === FALSE)
              {
        ...
        $query = $this->db->get_where('tbl_news', array('news_id' => $id, 'news_slug' => $slug));
    ...
    public function news_detail_with_categoryz($slug)
    {
        $sql = 'SELECT * 
                FROM tbl_news t1
                JOIN tbl_category t2
